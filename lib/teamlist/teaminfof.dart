...
class TeamInfoF extends StatefulWidget {
  late String _name;
  late String _goal;
  ...
  late int _members;
  TeamInfoF(String name, String goal, String duration, String time, String deposit, int members, {super.key}){
    _name = name;
    _goal = goal;
    _duration = duration;
    _time = time;
  ...
  @override
  _TeamInfoFState createState() => _TeamInfoFState(_name,_goal,_duration,_time,_deposit,_members);
}

class _TeamInfoFState extends State<TeamInfoF> {
  late String _name;
  late String _goal;
  late String _duration;
  late String _time;
  ...
  _TeamInfoFState(String name, String goal, String duration, String time, String deposit, int members) {
    _name = name;
    _goal = goal;
    _duration = duration;
    _time = time;
                                  ...
                                  onPressed: () async {
                                    await showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        ...
                                        return Popup(
                                          title:
                                              "Sorry for the inconvenience.\n\n You can only join \"Achievelab\" in the beta version.",
                                        );
                                      });
